...
| You need a **consistent format, tone, or narrow skill**, every time | **Fine-tuning** | You're teaching *behavior* — that's what training adjusts |
| A few examples in the prompt already get it right | **Few-shot prompting** | Cheaper, instant, no training loop — try this first |
